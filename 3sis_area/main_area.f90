...
!====Main====
index = 3  ! The year you select as the truth year
...
open(12,file='particles_12months_test_sis_area.bin',&
    access='direct',form='unformatted',&
    status='replace',recl=kind_num*count_key(4))
do i=1,12
	write(12,rec=i) particles_12m(:,i)
enddo
close(12)
